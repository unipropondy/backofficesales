...
async function check() {
  try {
    ...
    const tests = [
      { dStatus: [0, 1, 2, 4], taf: false, daf: false, isf: false, name: "No filters (Raw Union)" },
      ...
      { dStatus: [0, 1, 4], taf: false, daf: false, isf: true, name: "Exclude DetailStatus=2, InvoiceStatus=5" },
      { dStatus: [0, 1, 4], taf: false, daf: true, isf: true, name: "Exclude DetailStatus=2, DetailAmount>0, InvoiceStatus=5" }
    ];
